...
async def awake(event):
  ...
  NAO = f"**Holla, I'm Nikhil Bot!** \n\n"
  NAO += "🔴 **I'm Working Properly** \n\n"
  NAO += "🔴 **My Master : [Sayonara](https://t.me/nikhilowner)** \n\n"
  NAO += f"🔴 **Telethon Version : {tlhver}** \n\n"
  NAO += f"🔴 **Pyrogram Version : {pyrover}** \n\n"
  NAO += "**Thanks For Adding Me Here ❤️**"
  BUTTON = [[Button.url("ʜᴇʟᴘ", "https://t.me/nikhilowner?start=help"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/dost_hai_sab")]]
